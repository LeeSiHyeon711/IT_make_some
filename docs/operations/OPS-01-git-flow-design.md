...
> 기존 헌법·`docs/operations/공정개선-v2.md`·커맨드/에이전트/훅 정의는 변경하지 않는다. git commit/push도 하지 않는다.
...
1. `docs/operations/공정개선-v2.md` — 자동화 레벨(L0/L1/**L1.5**/L2) 개념과 **기본값 L1.5**, L2 승격 조건(루프 3회+) 절 추가.
...
|---------|------|----------|-----------|--------|
| OPS-01-A | 자동화 레벨(L0/L1/L1.5/L2) 개념·기본값 L1.5·L2 승격조건 문서화 | `docs/operations/공정개선-v2.md` | C10 | 낮음 |
