...
(상세 수치·산식: [`docs/PickUpMemo_v1_v2_생산성비교.md`](docs/PickUpMemo_v1_v2_생산성비교.md))
...
| [`docs/PickUpMemo_v1_v2_생산성비교.md`](docs/PickUpMemo_v1_v2_생산성비교.md) | v1→v2 Builder 토큰 생산성 비교 (실측) |
